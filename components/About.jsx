		...
		<section id="about">
			<div className="grid justify-items-left grid-flow-row mx-12 pt-20 gap-4 px-2 md:px-8 text-md text-slate-400 tracking-wide" >
				...
				<p>
					...
					<a className='text-slate-200 link-transition' href="https://www.linkedin.com/posts/global-formula-racing_unleashing-nostalgia-test-day-throwback-activity-7068290736735047680-Y3xI/" target="_blank" rel="noreferrer">preparing a racecar for competition</a>
				...
				<p>
					...
					<a className='text-slate-200 link-transition' href="https://www.linkedin.com/posts/npragin_hey-everyone-ive-been-working-hard-activity-7169460021712314368-134z" target="_blank" rel="noreferrer">color matching Pokémon to sports teams</a>
					.
